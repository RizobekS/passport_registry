...
class Horse(models.Model):
    ...
    country_of_birth = models.ForeignKey(Country, verbose_name="Место рождения (Страна)", on_delete=models.SET_NULL, null=True)
    place_of_birth = models.ForeignKey(Region, verbose_name="Регион", on_delete=models.SET_NULL, null=True)
